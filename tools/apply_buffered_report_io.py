...
note = "Fast Audit hot-loop output is buffered through persistent file descriptors, avoiding thousands of repeated FAT file open/close operations during discovery and report generation. Duplicate-hash reporting is also generated in a single pass. This is a performance-only optimization; audit results and safety semantics are unchanged."
